...
public class BibliotecaIntegration {
	...
	@When("^busco la Biblioteca \"([^\"]*)\" para seleccionarlo de la tabla de Biblioteca$")
	public void busco_el_Biblioteca_para_seleccionarlo_de_la_tabla_de_Biblioteca(String arg1) throws Throwable {
		try {
